...
def require_go_server():
    try:
        requests.get(f"{GO_HOST}/api/v1/system/ping", timeout=2)
    except requests.RequestException as exc:
        pytest.skip(f"Go API server is not available at {GO_HOST}: {exc}")
...
# ---------------------------------------------------------------------------
@pytest.mark.p2
def test_search_datasets_consistency_basic(require_go_server, rest_client, all_datasets):
    """
...
# ---------------------------------------------------------------------------
@pytest.mark.p2
def test_search_datasets_consistency_metadata_filter(require_go_server, rest_client, all_datasets):
    """
...
# ---------------------------------------------------------------------------
@pytest.mark.p2
def test_search_datasets_consistency_with_search_id(require_go_server, rest_client, all_datasets):
    """
...
# ---------------------------------------------------------------------------
@pytest.mark.p2
def test_search_datasets_consistency_multi_dataset(require_go_server, rest_client, all_datasets):
    """
...
# ---------------------------------------------------------------------------
@pytest.mark.p2
def test_search_datasets_consistency_english(require_go_server, rest_client, all_datasets):
    """
