...
class TestEvaluationFrameworkDemo:
    ...
    def test_mock_evaluation_service(self):
        ...
        success, collection_id = mock_service.create_collection(name="Test collection")
    ...
    def test_mock_test_case_addition(self):
        ...
        success, case_id = mock_service.add_test_case(collection_id="collection_123", question="Test question?", reference_answer="Test answer")
    ...
    def test_mock_evaluation_run(self):
        ...
        success, run_id = mock_service.create_run_config(collection_id="collection_123", target_type="dialog", target_id="dialog_456", user_id="user_1")
    ...
    def test_mock_metrics_computation(self):
        ...
        metrics = {"precision": 0.85, "recall": 0.78, "f1_score": 0.81, "hit_rate": 1.0, "mrr": 0.9}
        mock_service._compute_retrieval_metrics.return_value = metrics

        result = mock_service._compute_retrieval_metrics(retrieved_ids=["chunk_1", "chunk_2", "chunk_3"], relevant_ids=["chunk_1", "chunk_2", "chunk_4"])
    ...
    def test_collection_list_structure(self):
        ...
        expected_result = {"total": 3, "collections": [{"id": "collection_1", "name": "collection 1"}, {"id": "collection_2", "name": "collection 2"}, {"id": "collection_3", "name": "collection 3"}]}
        mock_service.list_collections.return_value = expected_result

        result = mock_service.list_collections(tenant_id="tenant_1", user_id="user_1", page=1, page_size=10)
    ...
    def test_bulk_import_success_count(self):
        ...
        success_count, failure_count = mock_service.import_test_cases(collection_id="collection_123", cases=[{"question": f"Q{i}"} for i in range(10)])
    ...
    def test_recommendation_severity_levels(self):
        ...
        for severity in severities:
            rec = {"issue": "Test Issue", "severity": severity, "suggestions": ["Fix it"]}
