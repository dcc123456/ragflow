...
def test_split_model_name_with_at_symbol_in_model_name_lm_studio_embedding():
    ...
    pure, instance, provider, tenant_id = split_model_name(composite)
...
def test_split_model_name_plain_three_part():
    ...
    pure, instance, provider, tenant_id = split_model_name("gpt-4o@eastus@OpenAI")
...
def test_split_model_name_two_part_defaults_instance():
    ...
    pure, instance, provider, tenant_id = split_model_name("gpt-4o@OpenAI")
...
def test_split_model_name_bare_model_name():
    ...
    pure, instance, provider, tenant_id = split_model_name("qwen2.5-7b-instruct")
...
def test_split_model_name_three_part_with_at_in_model_name():
    ...
    """
    pure, instance, provider, tenant_id = split_model_name("foo@bar@HuggingFace")
...
def test_split_model_name_returns_tuple_of_strings():
    """Sanity: the function must always return four string values."""
    pure, instance, provider, tenant_id = split_model_name("a@b@c")
