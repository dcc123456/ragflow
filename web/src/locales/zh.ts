...
程序记忆: 学习的技能、习惯和自动化程序。`,
    ...
    tickets: {
      ...
      closeTitle: '关闭工单',
      closeConfirmMessage: '您的问题是否已经解决？',
      myTicket: '我的工单',
      states: {
        new: '新建',
        open: '处理中',
        pendingClose: '等待关闭',
        pendingReminder: '挂起提醒',
        closed: '已关闭',
      },
      priorities: {
        low: '低',
      ...
      detail: {
        ...
        sendReply: '发送',
        closedNotice: '该工单已关闭。',
        dragDropHint: '拖拽文件到此处',
        uploadLimit: '最多 {{count}} 个文件，单个不超过 {{size}}',
      },
      form: {
        title: '标题',
        ...
        customer: '客户邮箱',
        customerPlaceholder: '请输入客户邮箱',
        articleSubject: '文章主题',
        articleSubjectPlaceholder: '请输入主题',
        articleBody: '文章内容',
        articleBodyPlaceholder: '请输入工单描述',
        attachments: '附件',
        uploadAttachment: '点击或拖拽文件上传',
      },
    },
    memory: {
      messages: {
