...
from tools.billing.billing_common import (  # noqa: E402
    ...
    make_default_parser, wait_for_no_pending_downgrade,
)
from tools.billing.flow_common import (  # noqa: E402
    complete_trial_checkout_upgrade,
...
from tools.billing.storage_common import (  # noqa: E402
    ...
    downgrade_to_trial,
    get_pro_quota_apps,
    upgrade_starter_to_pro, setup_starter,
)
...
def run_flow(args: argparse.Namespace) -> None:
    ...
    setup = setup_starter(args, email)
    ...
    # input("before advance_clock_to_plan_end")
    client.advance_clock_to_plan_end()

    # input("after advance_clock_to_plan_end")
    # client.ensure_invoice_finalized(pro_subscription_id)
    # subscription = stripe.Subscription.retrieve(pro_subscription_id, expand=["latest_invoice"])
    # invoice = extract_latest_invoice_obj(subscription)
    # invoice_id = invoice.get("id", "")
    # client.post_invoice_paid_event(invoice_id)
    # input("after post_invoice_paid_event")
