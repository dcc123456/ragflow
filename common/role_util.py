...
KB_API_ACTION_MAP = {
    ...
    "upload_info": ActionEnum.WRITE,
    "metadata_summary": ActionEnum.READ,
    "metadata_batch_update": ActionEnum.WRITE,
    "update_document": ActionEnum.WRITE,
    "upload_document": ActionEnum.WRITE,
    "list_docs": ActionEnum.ENABLE,
    "delete_documents": ActionEnum.WRITE,
    "update_metadata_config": ActionEnum.WRITE,
    "list_thumbnails": ActionEnum.READ,
    "update_metadata": ActionEnum.WRITE,
    "ingest": ActionEnum.WRITE,
    "parse_documents": ActionEnum.WRITE,
    "stop_parse_documents": ActionEnum.WRITE,
    "get_document_image": ActionEnum.READ,
    "get_artifact": ActionEnum.READ,
    "batch_update_document_status": ActionEnum.WRITE,
    "get": ActionEnum.READ,
    "download": ActionEnum.READ,
    "download_document": ActionEnum.READ,
}
