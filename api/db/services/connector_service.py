...
from api.db.db_models import DB, Connector, SyncLogs, Connector2Kb, Knowledgebase, File
    ...
    def link_connectors(cls, kb_id: str | None = None, connectors: list[dict] = [], folder_id: str | None = None, tenant_id: str = ""):
        ...
        for conn in connectors:
            ...
            if conn_id in old_conn_ids:
                ...
                continue
            info = {"id": get_uuid(), "connector_id": conn_id, "kb_id": kb_id, "auto_parse": conn.get("auto_parse", "1"), "is_kb": "0" if folder_id else "1"}
