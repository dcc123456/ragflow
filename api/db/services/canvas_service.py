...
class UserCanvasService(CommonService):
    ...
    def accessible(cls, canvas_id, tenant_id):
        ...
        for user_tenant in user_tenants:
            ...
            if perm and perm.permission >= PermissionValue.PERMISSION_READ.value and getattr(perm, "status", StatusEnum.VALID.value) == StatusEnum.VALID.value:
                return True
        return False
