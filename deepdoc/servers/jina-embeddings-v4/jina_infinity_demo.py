...
def infinity_index():
    ...
    table_instance = db_instance.create_table("jina_infinity_demo", {
    ...
    table_instance.create_index("index1",
                                infinity.index.IndexInfo("embedding",
...
def infinity_search():
    ...
    for i, query_embedding in enumerate(query_embeddings):
        ...
        res, extra_result = table_instance.output(["file_name", "page_num", "SIMILARITY()"]).match_dense(
            "embedding", query_embedding_flatten, "float", "ip", 5).to_pl()
