        ...
        for cks in settings.docStoreConn.scroll(flds, {"kb_id": task_dataset_id}, [], 0, B, index_name, [task_dataset_id]):
            ...
            for t in range(retry):
                try:
                    ...
                    token_count, target_vector_size = await asyncio.wait_for(embedding_service.embed_chunks(docs, target_embedding_model, task_parser_config), timeout=len(docs) * 3)
                except Exception as e:
